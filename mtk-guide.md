...
# Table of Contents
0. [Back up](/mtk-guide.md#0-back-up-your-data)

I. [Unlocking the bootloader](/mtk-guide.md#i-unlocking)
1. [Installing Prerequisites](/mtk-guide.md#1-installing-prerequisites)
2. [Downgrade to RUI2](/mtk-guide.md#2-downgrade-to-rui2)
3. [Unlocking the bootloader](/mtk-guide.md#3-unlocking-the-bootloader)
4. [Upgrade to RealmeUI 3](/mtk-guide.md#4-upgrade-to-realmeui-3)

II. [Patching `lk` - qetting fastboot access and removing dm-verity and orange state](/mtk-guide.md#ii-patching-lk--qetting-fastboot-access-and-removing-dm-verity-and-orange-state-warnings--skip-only-if-you-unlocked-with-deep-testing)  
III. [Installing a Custom ROM](/mtk-guide.md#iii-installing-a-custom-recovery-and-rom)  
IV. [Rooting](/mtk-guide.md#iv-rooting)  
...
## Go to [Custom ROM Guide](/custom-rom.mtk-guide.md)
* * *
# IV. Rooting 
